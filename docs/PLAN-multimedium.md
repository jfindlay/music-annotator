...
| S9 | done     | 195863a | — (◆ capstone)         | Opus writeup; 3 new NOTES.md invariants (cross-medium aggregation / concerto-soloist accumulation / regrouped journal obligation); README.md audit+regroup docs + concerto-soloist path note; codebase-audit handoff brief; concerto-allowlist deferral → BACKLOG.md; corrected stale "audit not-yet-built" note |
